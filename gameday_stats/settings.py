"""
Django settings for gameday_stats project.
...
ALLOWED_HOSTS = ['gameday-stats.onrender.com', 'localhost', '127.0.0.1']
...
ROOT_URLCONF = 'gameday_stats.urls'
...
WSGI_APPLICATION = 'gameday_stats.wsgi.application'
...
CSRF_TRUSTED_ORIGINS = ['https://gameday-stats.onrender.com']
